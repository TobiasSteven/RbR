    ...
    return (
        <>
          ...
          <View style={styles.container}>
            ...
            <View style={{flex: 2}}>
              <Image source={images.splash3} style={{height: '100%', width: '100%'}} resizeMode='contain'/>
            </View>
            ...
            <View style={{flex: 1,}}>
              <View style={{flex: 1.5, justifyContent: 'center', alignItems: 'center',}}>
                ...
                <View style={{flex: 0.6,}}>
                  <Text style={{fontWeight: 'bold', color: '#000', fontSize: 18}}>STAY MOTIVATED</Text>
                </View>
                <View style={{flex: 1, width: '85%',}}>
                  <Text style={{fontWeight: 'bold', color: '#000', fontSize: 13, textAlign: 'center'}}>Connect with running buddies and stay accountable through shared challenge</Text>
                </View>
              ...
              <View style={{flex: 1, justifyContent: 'center', alignItems: 'flex-end', paddingRight: 30}}>
                ...
                <TouchableOpacity style={styles.button} onPress={() => this.props.navigation.navigate('SignScreen')}>
